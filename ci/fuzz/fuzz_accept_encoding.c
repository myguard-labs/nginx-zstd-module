 ...
 *
 * The real functions live in ../../src/ngx_http_zstd_accept_encoding.h (the
 * zstd wrapper in ../../src/ngx_http_zstd_common.h) and depend on the
 ...
 * ../../src/ngx_http_zstd_accept_encoding.h and
 * ../../src/ngx_http_zstd_common.h. Contains the verbatim bodies of
 * ngx_http_zstd_eval_qvalue() and ngx_http_zstd_accept_encoding(). */
